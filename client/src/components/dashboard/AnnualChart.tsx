...
const AnnualChart: FC<AnnualChartProps> = ({ data }) => {
  ...
  return (
    <div className='shadow-lg rounded-2xl p-5 border-4 border-emerald-400 dark:border-indigo-400 bg-white dark:bg-slate-700 flex flex-col items-center justify-center'>
